...
from filters.filters import MainMenu,MealNameSearch,ProductSearch,CaloriesSearch,ProductNameSearch,Search

def search_menu():
    builder=InlineKeyboardBuilder()
    builder.button(text='Поиск по названию блюда',callback_data=MealNameSearch())
    builder.button(text='Поиск по названию ингридиента',callback_data=ProductNameSearch())
